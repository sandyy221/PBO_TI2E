...
public class TestBackend {
    public static void main(String[] args) {
        // PERBAIKAN: Gunakan id kategori yang ADA di database
        Kategori novel = new Kategori().getById(35);     // 35 = Novel (bukan 27)
        Kategori referensi = new Kategori().getById(36); // 36 = Referensi (bukan 28)
